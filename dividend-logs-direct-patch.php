<?php
/**
 * File: dividend-logs-direct-patch.php
 * Description: Direct patch for dividend logs to add date range picker without complex dependencies
 */
...
try {
    ...
    $summaryStats = [];
    $filterOptions = ['years' => [], 'currencies' => []];
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Dividend Transaction History - PSW 4.0</title>
    ...
    <link rel="stylesheet" href="assets/css/dividend-logs.css">
...
<body>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!picker.contains(e.target) && overlay.style.display === 'block') {
                closeDateRangePicker();
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!fromInput.value && !toInput.value) {
                ...
                document.getElementById('dateRangeText').textContent = defaultFrom + ' - ' + defaultTo;
            }
        });

        // Export and print functions
        function exportDividendLogs() {
